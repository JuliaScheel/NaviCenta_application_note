...
The Molecular Interaction Map (MIM) contains signal flow diagrams and are enriched with regulatory components i.e. TF, miRNA, lncRNA and drug interaction data (Figure 2B) [10]. .![](images/layers_and_workflow.png)
